...
export default createStore(
  {
    ...
    mutations: {
      ...
      UPDATE_MENU_DATA(state, playload) {
        state.menuDataArr = playload
      },
      // 비주얼데이터를 업데이트 한다.
      UPDATE_VISUAL_DATA(state, playload){
        state.visualDataArr = playload
      },
      UPDATE_GALLERY_DATA(state, playload){
        state.galleryDataArr = playload
      },
      UPDATE_MOVIE_DATA(state, playload){
        state.movieData = playload
      },
      UPDATE_INFO_DATA(state, playload){
        state.infoDataArr = playload
      },
      UPDATE_NEWS_DATA(state, playload){
        state.newsDataArr = playload
      },
      UPDATE_BANNER_DATA(state, playload){
        state.bannerDataArr = playload
      },
